  ...
  <div id="allwrapper">
    <div id="centerwrapper">
      ...
      <div class="wrapper fadeInDown">
        ...
        <div id="formContent">
          <label>*NAME</label>
          <input type="text" id="name" class="fadeIn second" name="name" placeholder="Input Your Name">
          <label>*EMAIL</label>
          <input type="text" class="fadeIn second" id="email" name="email" placeholder="Input Your Email">
          <br>
