...
<!--               </div> -->
	...
	<form action="ComunityWrite.do" method="post">
...
<!--            <input type="text" class="form-control W-25"/> -->
				...
				<input type="text" class="form-control w-50" placeholder="" name="writer" >
<!-- 				 <label>File : </label> -->
<!-- 				<input type="text" class="form-control w-50" placeholder="File" > -->
                ...
                <input type="submit"  href="ComunityWrite.do" class="btn btn-secondary" value="Enter Text" "><span class="glyphicon glyphicon-envelope text-light"></span> </a>
                <input type="button" href="CommunityController.do" class="btn btn-secondary" value="Cencel"><span class="glyphicon glyphicon-tags text-light"></span>   </a>
