					...
					<div class="row">
						<div id=wrapper>
							...
							<div class="col-lg-8">
								...
								<div .main>
									<div id='img_div'>
										<img class="img-fluid rounded" alt="" id=product_img src='${mainfile}'>
									</div>
												...
												<table class="table">
													<thead>
														<tr>
															...
															<td><input type=button id=bidcancel
																value='취소'></td>
													...
													<tbody>
														...
														<tr>
															<td><input id="bidaccount" type="number"
																placeholder='${num}' step='${bdto.bidunit}'></td>
															<td class="text-right"><input type=button id=bidbtn
																value='Place Bid'></td>
														</tr>
														<tr>
															<td colspan=2>Enter ${num} WON or more</td>
														</tr>
														<tr>
															<td></td>
															<td></td>
...
<input type="hidden" id="seq" name="board_no" value="${bdto.board_seq}">
<input type="hidden" id="resttime" name="board_no" value="${endhour}">
										<!--                                        모달 -->
          ...
          <button type="button" class="btn btn-secondary" data-dismiss="modal">확인</button>
								...
								<div id=files>
									<c:forEach var="item" items="${path}">
										<img class="img-fluid rounded" alt="" id=product_img
											src='${item}'>
										<br>
										<br>
									</c:forEach>
							...
							<div class="card my-4">
								...
								<div class="card-body">
									<form class="text-right"
										action='comment.co?seq=${bdto.board_seq}&sell_type=${bdto.sell_type}'
										method=post>
