...
<!--                 <label>Title : </label> -->
<!--                 <input type="text" class="form-control w-100"   name="title"  placeholder=${dto.title}  readonly> -->
<!--                 <label>Writer : </label> -->
       
<!-- <!--            <input type="text" class="form-control W-25"/> --> -->
		

<!-- 				<input type="text" class="form-control w-50" placeholder=${dto.writer} name="loginid" readonly> -->
<!-- <!-- 				 <label>File : </label> --> -->
...
<!--                 <textarea rows="9" class="form-control" name="contents"  placeholder=${dto.contents} readonly></textarea> -->
<!--                 <hr/> -->
                
<!--                 <table border=1> -->
<!--                 </table> -->
<!-- 		<form action="CommentWrite.co" method="get">       -->
<!--       		<input type="text" class="form-control " id="comment_text" name="comment_text" placeholder="comment_text" > -->
<%--       		<input type="hidden" name="seq" value="${dto.seq}"> --%>
<%-- <%--       		<input type="hidden" name="count" value="${dto.viewcount}"> --%> --%>
<!--              <input type="submit" class="btn btn-secondary" value="Enter Comment" "><span class="glyphicon glyphicon-envelope text-light"></span>     -->
<!--       </form>          -->
               
     
			 
<%-- 	<form action="CommentModifyproc.co?comment_seq=${item.comment_seq}&seq=${dto.seq}" method="post">			 --%>
<!-- 	<table border=1> -->
...
<!-- 						 <input type="text" class="form-control"   name="comment_text"  placeholder=${item.comment_text} > -->
...
<!-- 						 <input type="submit" class="btn btn-secondary" value="commentmodify" "> -->
					
						
<!--                <td id="delbtn" style="width: 11%"> -->
<!--                   <script> -->
//                   $("#delbtn:last-child").after("<button type=button id="+num+" class='btn btn-secondary' value='${item.comment_seq}'>X</button>");
<!--                   </script> -->
<!--                </td> -->
<!--             </tr> -->
...
<!--                <input type="button"  id=back class="btn btn-secondary" value="back"><span class="glyphicon glyphicon-tags text-light"></span> -->
<!--                <input type="button"  id=delete class="btn btn-secondary" value="delete"><span class="glyphicon glyphicon-tags text-light"></span> -->
<!--                <input type="button"  id=modify class="btn btn-secondary" value="modify "><span class="glyphicon glyphicon-tags text-light"></span> -->
