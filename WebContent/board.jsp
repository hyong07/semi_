...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            <div class="w-25 h-100 col-md-4 col-lg-2"></div>
            <div class="col-md-4 w-75 col-lg-9">
              <div class="row mx-1 py-2">
                <div class="btn-group">
                  <a href="#" class="btn btn-secondary">All View</a>
                  <a href="#" class="btn btn-secondary">Auction</a>
                  <a href="#" class="btn btn-secondary">Buy It Now</a>
                </div>
                <div style="width:400px"> </div> sort
              ...
              <div class="row">
                <div class="col-md-3 m-0 p-0">
                  <div class="card">
                    ...
                    <a href="#" class="card-link text-left m-0 p-3">제목</a>
            ...
            <div class="col-md-4 w-25 col-lg-1"></div>
          </div>
          <div class="row"> </div>
        </div>
      </div>
