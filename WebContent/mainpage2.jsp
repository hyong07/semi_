...
<body>
		...
		<div class="collapse navbar-collapse text-center justify-content-end"
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link"
					href="terms_of_use.jsp"> <i class="fa fa-user fa-fw"></i> Sign
						up
				</a></li>
			</ul>
			<a class="btn navbar-btn ml-2 btn-secondary text-white"
				href="mypage.jsp"> <i class="fa d-inline fa-lg fa-user-circle-o"></i>
				My Page
	...
	<div id="headerwrapper">
		...
		<div id="centernavbar">
			...
			<li class="nav-item"><a class="nav-link  text-secondary"
				id="menubtn" href="board.bo?ca1=패션"> <i
					class="fa d-inline fa-lg fa-bookmark-o"></i> 패션
			</a></li>
			<li class="nav-item"><a class="nav-link  text-secondary"
				id="menubtn" href="board.bo?ca1=전자제품"> <i
					class="fa d-inline fa-lg fa-bookmark-o"></i> 전자제품
			</a></li>
			<li class="nav-item"><a class="nav-link  text-secondary"
				id="menubtn" href="board.bo?ca1=리빙"> <i
					class="fa d-inline fa-lg fa-bookmark-o"></i> 리빙
			</a></li>
			<li class="nav-item"><a class="nav-link  text-secondary"
				id="menubtn" href="board.bo?ca1=문화"> <i
					class="fa d-inline fa-lg fa-bookmark-o"></i> 문화
			</a></li>
			<li class="nav-item"><a class="nav-link  text-secondary"
				id="menubtn" href="board.bo?ca1=뷰티"> <i
					class="fa d-inline fa-lg fa-bookmark-o"></i> 뷰티
			</a></li>
			...
			<li class="nav-item"><a class="nav-link  text-secondary"
				id="menubtn" href="saleInput.jsp"> 상품등록</a></li>

			<li class="nav-item"><a class="nav-link  text-secondary"
				id="menubtn" href="communitymain.jsp"> 커뮤니티</a></li>
								...
								<div id="carouselExampleControls" class="carousel slide"
									...
									<div class="carousel-inner mx-0"  id="carousel">
										<div class="carousel-item active">
											<img class="d-block w-100" src="&#xAD11;&#xACE0;1.jpg">
										</div>
										<div class="carousel-item">
											<img class="d-block w-100" src="&#xAD11;&#xACE0;4.jpg">
										</div>
										<div class="carousel-item">
											<img class="d-block w-100" src="&#xAD11;&#xACE0;3.jpg">
										</div>
										<div class="carousel-item">
											<img class="d-block w-100" src="&#xAD11;&#xACE0;5.jpg">
										</div>
										<div class="carousel-item">
											<img class="d-block w-100" src="&#xAD11;&#xACE0;2.jpg">
										</div>
										<div class="carousel-item">
											<img class="d-block w-100" src="&#xAD11;&#xACE0;6.jpg">
										</div>
									</div>
								</div>
							</div>
